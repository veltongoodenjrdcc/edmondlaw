# CLAUDE.md — Edmond Law Website Project Brief

> **You are Claude Code working in VS Code on a production website for a real, paying client. This document is your single source of truth. Read it end-to-end before writing a single line of code. Re-read relevant sections before each new file. The client meeting is tomorrow. Do not improvise on requirements — execute them.**
